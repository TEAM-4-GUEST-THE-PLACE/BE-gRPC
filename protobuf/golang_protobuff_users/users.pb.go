...
type UpdateUserRequest struct {
	...
	DiamondsTotals string `protobuf:"bytes,2,opt,name=diamonds_totals,json=diamondsTotals,proto3" json:"diamonds_totals,omitempty"`
...
func (x *UpdateUserRequest) GetDiamondsTotals() string {
	if x != nil {
...
var file_protobuf_users_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x64, 0x69, 0x61, 0x6d, 0x6f, 0x6e, 0x64, 0x73, 0x54,
